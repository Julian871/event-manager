...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, EventChangeMessage> consumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, EventChangeMessage.class.getName());
        return new DefaultKafkaConsumerFactory<>(props);
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, EventChangeMessage> containerFactory() {
